...
//         `/api/streams?creatorId=6b71740c-ebc7-4ba8-9036-c091f14fea39`,
//         { credentials: "include" }
//       );
...
//         method: "POST",
//         body: JSON.stringify({
//           creatorId: "6b71740c-ebc7-4ba8-9036-c091f14fea39",
//           url: inputLink,
//         }),
//       });
...
export default function Dashboard() {
  ...
  const refreshStreams = useCallback(async () => {
    ...
    try {
      ...
      console.log("Error refreshing streams:", error);
      setQueue([]);
      setCurrentVideo(null);
    }
  }, [session?.user?.id]);
  ...
  const handleShare = (
    ...
    const shareableLink = `${window.location.hostname}/creator/${session?.user?.id}`;
